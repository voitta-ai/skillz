...
- [AudioManager.setCommunicationDevice](https://developer.android.com/reference/kotlin/android/media/AudioManager#setcommunicationdevice)
  <!-- Kotlin reference variant on purpose: the Java URL's path contains a run
       of exactly 40 characters from [A-Za-z0-9/+], which trips the
       aws-secret-key structural check in scripts/check-sensitive-terms.sh.
       Same page, same anchor. Do not 'fix' it back. -->
